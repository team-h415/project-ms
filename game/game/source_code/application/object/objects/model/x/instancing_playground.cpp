...
// InstancingPlaygound()
//-------------------------------------
InstancingPlaygound::InstancingPlaygound(
	const OBJECT_PARAMETER_DESC &parameter)
{
	...
	texture_ = TextureManager::GetTexture("resource/texture/game/suberi.jpg");

	XContainer* container = XContainerManager::GetContainer("./resource/model/x/suberi.x");
...
// Update()
//-------------------------------------
void InstancingPlaygound::Update()
{
