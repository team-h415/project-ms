	...
	const OBJECT_PARAMETER_DESC &parameter)
{
	...
	base_scaling_.x_ = parameter_.scaling_.x_;
	base_scaling_.y_ = parameter_.scaling_.y_;
...
void CountDown::Update()
{
	...
	if(timer_ != 0)
	{
		alpah = 1.0f / 60 * frame_count;
		parameter_.scaling_.x_ = base_scaling_.x_ / 60 * frame_count;
		parameter_.scaling_.y_ = base_scaling_.y_ / 60 * frame_count;
	}
	else
	{
		alpah = 1.0f / 30 * (60 - frame_count);
		parameter_.scaling_.x_ = base_scaling_.x_ / 30 * (60 - frame_count);
		parameter_.scaling_.y_ = base_scaling_.y_ / 30 * (60 - frame_count);
	}
...
void CountDown::CalculateVertex()
{
	...
	vertex_[0].diffuse_ = D3DXCOLOR(1.0f, 1.0f, 1.0f, alpah);
	vertex_[1].diffuse_ = D3DXCOLOR(1.0f, 1.0f, 1.0f, alpah);
	vertex_[2].diffuse_ = D3DXCOLOR(1.0f, 1.0f, 1.0f, alpah);
	vertex_[3].diffuse_ = D3DXCOLOR(1.0f, 1.0f, 1.0f, alpah);
